...
const UpdatePassword = () => {
  ...
  function updatePassword(e) {
    ...
    if (validateForm()) {
      if (token) {
        fetchWithToken(
          `${process.env.REACT_APP_API_BASE_URL}/api/user/updatePassword`,
          {
            method: "PUT",
            headers: {
      ...
      <div className="updateMain">
        <Form onSubmit={updatePassword}>
          <div>
            ...
            <input type="password" name="password" onChange={infoChange} />
          </div>
          ...
          <div>
            ...
            <input type="password" name="repassword" onChange={infoChange} />
            {passwordMatchErr && (
              <div>
            ...
            {isEmptyPassword && (
              <div>
                <small className="text-danger">비밀번호를 입력하세요.</small>
              </div>
            )}
          </div>
          <Button id="otherBtn" variant="light" onClick={goBack}>
            이전으로
          </Button>
          <Button id="updateBtn" variant="light" onClick={updatePassword}>
            비밀번호 수정
          </Button>
        </Form>
      </div>
