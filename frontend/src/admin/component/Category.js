...
const Category = ({ setModalToggle }) => {
  ...
  const createCategory = async () => {
    if (
      validation(parentInputValue, "parent") &&
      validation(childInputValue, "child")
    ) {
      try {
  ...
  return (
    <div className={`${styles.container}`}>
      <div className={`${styles.header}`}>
        <span
          className={`${styles.cancleBtn} ${styles.addPointer}`}
          onClick={() => {
            ...
            <>
              <div
                ...
                className={`${styles.category} ${
                  m.main === activeCategory ? styles.active : ""
                }`}
                onClick={() => {
                  handleCategoryClick(m);
                  setUpdateSub("");
                }}
              >
                {m.main}
              ...
              {m.sub.map((s) => (
                <div
                  ...
                  className={`${styles.sub} ${
                    s === activeCategory ? styles.subActive : ""
                  }`}
                  onClick={() => {
                    handleSubSelect(m.main, s);
                    setUpdateSub("");
                  }}
                >
                  {s}
            ...
            <>
              <div className={`${styles.categoryNameBox}`}>
                <div>
                  ...
                  <div
                    id="categoryInputP"
                    className={`${styles.categoryName} ${styles.focusWithin}`}
                  >
                    <input
                      type="text"
                      placeholder="대 분류"
                ...
                {validParent && (
                  <div className={`${styles.valid}`}>{validParent}</div>
                )}
                <br></br>
                <div>
                ...
                {validChild && (
                  <div className={`${styles.valid}`}>{validChild}</div>
                )}
                <button
                  type="button"
            ...
            <>
              <div className={`${styles.categoryNameBox}`}>
                <label htmlFor="categoryInput">
                  선택된 상위 카테고리 {selectCategory.main}
                </label>
                <div
                  id="categoryInput"
                  className={`${styles.categoryName} ${styles.focusWithin}`}
          ...
          {categoryToggle === "update" && (
            <>
              <div className={`${styles.categoryNameBox}`}>
                ...
                <div
                  id="categoryInput"
                  className={`${styles.categoryName} ${styles.focusWithin} ${styles.updateSub}`}
                >
                  <input
                    name="sub"
                    type="text"
                ...
                {selectCategory && (
                  <div className={`${styles.updateInnerBtn}`}>
                    <button type="button" onClick={handleSubCategoryUpdate}>
                      변경
                    </button>
